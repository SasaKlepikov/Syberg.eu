    ...
    public function igthemes_welcome_admin_notice() {
        ?>
            <div class="updated fade">
                <p>
                    <?php echo sprintf( esc_html__( 'Thanks for choosing ' . wp_get_theme()->get( 'Name' ).'! You can read documentation to how get the most out of your new theme on the %swelcome screen%s.', 'store-wp' ), '<a href="' . esc_url( admin_url( 'themes.php?page=igthemes-welcome' ) ) . '">', '</a>' ); ?>
                </p>
                <p>
