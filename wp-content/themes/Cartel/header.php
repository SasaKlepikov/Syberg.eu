...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div class="topbar">
            ...
            <div onclick="wpml_language_selector_click.toggle();" class="sel-lang lang_sel_click"><?php _e('Select language','cartel'); ?></div>
          <?php do_action('icl_language_selector'); ?>
				</div>
				<div class="col-xs-6 top-right">
          <?php wp_nav_menu( array( 'theme_location' => 'user','menu_id' => 'cartel' ) ); ?>
					<?php wp_loginout(); ?> 
